      ...
      <div className="container mx-auto text-center">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
          ...
          <div className="bg-gray-700 p-8 rounded-lg transform hover:scale-105 transition duration-300">
            ...
            <a href="#" className="bg-blue-500 text-white px-6 py-2 rounded-lg hover:bg-blue-600 transition duration-300"><Link to='/generate'>Try Now</Link></a>
          </div>
          ...
          <div className="bg-gray-700 p-8 rounded-lg transform hover:scale-105 transition duration-300">
            ...
            <a href="#" className="bg-blue-500 text-white px-6 py-2 rounded-lg hover:bg-blue-600 transition duration-300"><Link to='/Summarize'>Try Now</Link></a>
          </div>
        </div>
      </div>
    </section>
